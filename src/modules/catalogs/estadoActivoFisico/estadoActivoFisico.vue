...
let headers = [
  { title: 'Estado físcio activo', align: 'center', key: 'estado_fisico_activo'},
        ...
        <v-col cols="12" xl="4" lg="3" sm="12" md="4">
          ...
          >
            <app-right-from-catalaog-component>
              <template #myCatalog>
                <v-text-field variant="solo" label="Estado físico del activo: *"></v-text-field>
            </template>
            </app-right-from-catalaog-component>
          </v-card>
        </v-col>
