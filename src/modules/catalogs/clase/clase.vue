...
let headers = [
  ...
  { title: 'Grupo pertenece', align: 'center', key: 'grupo_pertenece'},
        ...
        <v-col cols="12" xl="4" lg="3" sm="12" md="4">
          ...
          >
            <app-right-from-catalaog-component>
              <template #myCatalog>
                <v-text-field variant="solo" label="Nombre de la clase: *"></v-text-field>
                <v-select variant="solo" label="Código de la clase: *" :items="['a','b','c']"></v-select>
