        ...
        <v-col cols="12" xl="4" lg="3" sm="12" md="4">
          ...
          >
            <app-right-from-catalaog-component>
              <template #myCatalog>
                <v-text-field variant="solo" label="Nombre de la subclase: *"></v-text-field>
                <v-select variant="solo" label="Código de la subclase: *"     :items="['a','b','c']"></v-select>
                <v-select variant="solo" label="Grupo al que pertenece: *"    :items="['d','e','f']"></v-select>
                <v-select variant="solo" label="Clase a la que pertenece: *"  :items="['g','h','i']"></v-select>
            </template>
            </app-right-from-catalaog-component>
          </v-card>
        </v-col>
