...
let headers = [
  { title: 'Tipo de financiamiento', align: 'center', key: 'tipo_financiamiento'},
        ...
        <v-col cols="12" xl="4" lg="3" sm="12" md="4">
          ...
          >
            <app-right-from-catalaog-component>
              <template #myCatalog>
                <v-text-field variant="solo" label="Tipo de financiamiento: *"></v-text-field>
            </template>
            </app-right-from-catalaog-component>
          </v-card>
        </v-col>
